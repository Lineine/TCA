...
import net.mooctest.common.TestTypes.ArrayOfObjects;
import net.mooctest.common.TestTypes.BagOfPrimitiveWrappers;
import net.mooctest.common.TestTypes.BagOfPrimitives;
import net.mooctest.common.TestTypes.ClassWithArray;
import net.mooctest.common.TestTypes.ClassWithNoFields;
import net.mooctest.common.TestTypes.ClassWithObjects;
import net.mooctest.common.TestTypes.ClassWithTransientFields;
import net.mooctest.common.TestTypes.Nested;
import net.mooctest.common.TestTypes.PrimitiveArray;
