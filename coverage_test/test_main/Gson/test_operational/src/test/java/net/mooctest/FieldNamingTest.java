...
import static net.mooctest.FieldNamingPolicy.IDENTITY;
import static net.mooctest.FieldNamingPolicy.LOWER_CASE_WITH_DASHES;
import static net.mooctest.FieldNamingPolicy.LOWER_CASE_WITH_UNDERSCORES;
import static net.mooctest.FieldNamingPolicy.UPPER_CAMEL_CASE;
import static net.mooctest.FieldNamingPolicy.UPPER_CAMEL_CASE_WITH_SPACES;
import static net.mooctest.FieldNamingPolicy.UPPER_CASE_WITH_UNDERSCORES;

import net.mooctest.FieldNamingPolicy;
