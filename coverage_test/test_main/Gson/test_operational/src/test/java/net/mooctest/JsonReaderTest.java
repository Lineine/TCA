...
import static net.mooctest.stream.JsonToken.BEGIN_ARRAY;
import static net.mooctest.stream.JsonToken.BEGIN_OBJECT;
import static net.mooctest.stream.JsonToken.BOOLEAN;
import static net.mooctest.stream.JsonToken.END_ARRAY;
import static net.mooctest.stream.JsonToken.END_OBJECT;
import static net.mooctest.stream.JsonToken.NAME;
import static net.mooctest.stream.JsonToken.NULL;
import static net.mooctest.stream.JsonToken.NUMBER;
import static net.mooctest.stream.JsonToken.STRING;
