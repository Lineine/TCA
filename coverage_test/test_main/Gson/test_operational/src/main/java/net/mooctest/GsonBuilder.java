...
import static net.mooctest.Gson.DEFAULT_COMPLEX_MAP_KEYS;
import static net.mooctest.Gson.DEFAULT_DATE_PATTERN;
import static net.mooctest.Gson.DEFAULT_ESCAPE_HTML;
import static net.mooctest.Gson.DEFAULT_FORMATTING_STYLE;
import static net.mooctest.Gson.DEFAULT_JSON_NON_EXECUTABLE;
import static net.mooctest.Gson.DEFAULT_NUMBER_TO_NUMBER_STRATEGY;
import static net.mooctest.Gson.DEFAULT_OBJECT_TO_NUMBER_STRATEGY;
import static net.mooctest.Gson.DEFAULT_SERIALIZE_NULLS;
import static net.mooctest.Gson.DEFAULT_SPECIALIZE_FLOAT_VALUES;
import static net.mooctest.Gson.DEFAULT_STRICTNESS;
import static net.mooctest.Gson.DEFAULT_USE_JDK_UNSAFE;
...
import net.mooctest.internal.bind.TreeTypeAdapter;
...
public final class GsonBuilder {
   ...
   * that do not have the {@link net.mooctest.annotations.Expose} annotation.
   *
   * <p>This is a convenience method which behaves as if an {@link ExclusionStrategy} which excludes
   * these fields was {@linkplain #setExclusionStrategies(ExclusionStrategy...) registered with this
   * builder}.
  ...
  @InlineMe(
      ...
      imports = "net.mooctest.Strictness")
  @CanIgnoreReturnValue
