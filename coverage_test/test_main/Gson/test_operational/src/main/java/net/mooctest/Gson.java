...
import net.mooctest.internal.bind.ArrayTypeAdapter;
import net.mooctest.internal.bind.CollectionTypeAdapterFactory;
import net.mooctest.internal.bind.DefaultDateTypeAdapter;
import net.mooctest.internal.bind.JsonAdapterAnnotationTypeAdapterFactory;
import net.mooctest.internal.bind.JsonTreeReader;
import net.mooctest.internal.bind.JsonTreeWriter;
import net.mooctest.internal.bind.MapTypeAdapterFactory;
import net.mooctest.internal.bind.NumberTypeAdapter;
import net.mooctest.internal.bind.ObjectTypeAdapter;
import net.mooctest.internal.bind.ReflectiveTypeAdapterFactory;
import net.mooctest.internal.bind.SerializationDelegatingTypeAdapter;
import net.mooctest.internal.bind.TypeAdapters;
import net.mooctest.internal.sql.SqlTypesSupport;
 ...
 * </pre>
 *
 * <p>See the <a href="https://github.net.mooctest/blob/main/UserGuide.md">Gson User Guide</a>
...
public final class Gson {
   ...
   *   <li>By default, Gson ignores the {@link net.mooctest.annotations.Expose} annotation. You
   ...
   *   <li>By default, Gson ignores the {@link net.mooctest.annotations.Since} annotation. You
  ...
  public <T> TypeAdapter<T> getAdapter(TypeToken<T> type) {
    ...
    if (isInitialAdapterRequest) {
       ...
       * See https://github.net.mooctest/issues/625
       */
   ...
   *     {@link net.mooctest.reflect.TypeToken} class. For example, to get the type for {@code
  ...
  public void toJson(Object src, Type typeOfSrc, JsonWriter writer) throws JsonIOException {
    ...
    try {
      ...
      throw new AssertionError(
          "AssertionError (GSON " + "1.0" + "): " + e.getMessage(), e);
    } finally {
  ...
  // https://github.net.mooctest/pull/1700#discussion_r973764414
