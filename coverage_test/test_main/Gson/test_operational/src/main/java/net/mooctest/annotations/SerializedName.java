...
package net.mooctest.annotations;
 ...
 *
 * <p>This annotation will override any {@link net.mooctest.FieldNamingPolicy}, including the
 * default field naming policy, that may have been set on the {@link net.mooctest.Gson} instance.
 * A different naming policy can set using the {@code GsonBuilder} class. See {@link
 * net.mooctest.GsonBuilder#setFieldNamingPolicy(net.mooctest.FieldNamingPolicy)} for more
 * information.
 *
 ...
 *
 * @see net.mooctest.FieldNamingPolicy
